...
with_node \
  ...
  --target "/Users/apple/Documents/tennis-serve-analyzer-mobile/test-localization/ios/Pods/Target Support Files/Pods-testlocalization/ExpoModulesProvider.swift" \
  --entitlement "/Users/apple/Documents/tennis-serve-analyzer-mobile/test-localization/ios/testlocalization/testlocalization.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linking" "expo-localization" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
